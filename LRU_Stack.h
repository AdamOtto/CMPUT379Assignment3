 ...
 *
 * if q is global, allocate memory to q.element_count as well
 */
...
/* If LRU_add returns 0, a pageout didn't occur
 * If LRU_add returns 1, a pageout occured
 * If the new Object isn't in q, the passed in TLB_hit_index should be set to -1.
 */
